...
import spring_basic2.Membership2.configuration.AppConfigAutoDI;
import spring_basic2.Membership2.configuration.AppConfigConflictAutoDI;
import spring_basic2.Membership2.member.service.MemberService;

public class AppConfigAutoDITest {
    @Test
    @DisplayName("ComponentScan을 이용한 AppConfigComponent 테스트")
    void basicScan() {
        AnnotationConfigApplicationContext ac = new AnnotationConfigApplicationContext(AppConfigAutoDI.class);
    ...
    void basicConflictScan() {
        ...
        AnnotationConfigApplicationContext ac = new AnnotationConfigApplicationContext(AppConfigConflictAutoDI.class);
